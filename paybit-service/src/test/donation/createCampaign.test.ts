...
const validCampaign = {
  ...
  description:
    "This is a test donation campaign created for unit testing purposes. It includes a description that is long enough to meet the required minimum length.",
  goalAmount: 1000,
...
describe("Donation - Create Campaign Controller", () => {
  ...
  it("should successfully create a campaign without an image", async () => {
    const campaignWithoutImage = {
      ...
      description:
        "This is a test donation campaign without an image. The description is long enough to pass validation.",
      goalAmount: 500,
    };

...
describe("Auth - Change Password Controller", () => {
    it("should successfully change password with valid credentials", async () => {
        ...
        const passwordMatches = await bcrypt.compare(testUser.newPassword, user!.password);
    ...
    it("should return error when new password is the same as current password", async () => {
        await request(app)
            ...
            .expect((res) => {
                ...
                expect(res.body).toHaveProperty("message", "New password must be different from the current password.");
            });
    });
    ...
    it("should return error when new password is too weak", async () => {
        await request(app)
            ...
            .expect((res) => {
                ...
                expect(res.body).toHaveProperty("message", "New password must be at least 8 characters long.");
            });
    });
